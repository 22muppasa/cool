...
original_author="22muppasa"
original_name="cool"
original_urlname="cool"
original_description="Awesome cool created by 22muppasa" 
...
then
    ...
    echo "then run 'cool' or 'python -m cool'"
else
    poetry install
    echo "Applied Flask template"
    echo "Ensure you activate your env with 'poetry shell'"
    echo "then run 'cool' or 'python -m cool' or 'poetry run cool'"
fi
