...
- 🎯 Entry points to execute your program using `python -m <cool>` or `$ cool` with basic CLI argument parsing.
...
---
# cool Flask Application

Awesome cool created by 22muppasa
...
```bash
git clone https://github.com/22muppasa/cool cool
cd cool
make install
```
...
```bash
cool create-db   # run once
cool populate-db  # run once (optional)
cool add-user -u admin -p 1234  # ads a user
cool run
```
